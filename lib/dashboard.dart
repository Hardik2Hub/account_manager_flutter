...
import 'package:account/view.dart';
  ...
  get() async {
    ...
    if (l.length != 0) {
      for (int i = 0; i < l.length; i++) {
        String sql = "select sum(credit) from student1 where p_id=${l[i]['id']}";
        String sql1 = "select sum(debit) from student1 where p_id=${l[i]['id']}";
                    ...
                    return AlertDialog(
                      ...
                      actions: [
                        ...
                        TextButton(
                            onPressed: () {
                              name = t1.text;
                              String qry = "insert into student values(null,'$name')";
                                                      ...
                                                      children: [
                                                        IconButton(
                                                            onPressed: () {
                                                              ...
                                                              String qry1 = "delete from student1 where p_id=${l[index]['id']}";
                                                              dashboard
                                                                  .database!
                                                                  .rawDelete(
                                                                  qry);
